...
<div class="news_view">
	<div id="view_function">
		<ul>
			<li><a href="#" onclick="javascript:printView(${viewNews.num });"><img src="${ctxRoot }images/news/chi_icon_print.png" width="75" height="19" alt="Print this document" /></a></li>
			<li><a href="#" onclick="javascript:history.go(-1);"><img src="${ctxRoot }images/news/chi_icon_prev.png" width="75" height="19" alt="Previous page" /></a></li>
		</ul>
	</div>
	<div id="view_info">
		<div id="view_title">
