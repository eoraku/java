...
<div class="news_list">
	<div class="news_list_top">
		<div class="news_group_title">
			<img src="../images/news/eng_top_news_title.png" width="72" height="20"/>
		</div>
		<c:if test="${viewNewsHot }">
	...
	<div id="news_btm_pages">
		<table id="ul_news_pages">
			<tr>
				...
				<td><a class="page_prev" href="${urlQuery }${newsPaging.prev }">Previous page</a></td>
				</c:if>
				...
				<td><a class="page_next" href="${urlQuery }${newsPaging.next }">Next page</a></td>
				</c:if>
			</tr>
		</table>
	</div>
