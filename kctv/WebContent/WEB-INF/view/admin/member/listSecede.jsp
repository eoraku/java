...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td style="padding:10px;"><img src="../../images/admin/bul02.gif" width="4" height="5" hspace="5" align="absmiddle"><b>회원리스트</b></td>
	</tr>
</table>
	...
	<tr>
		<td>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="3" bgcolor="#CCCCCC">
				...
				<c:otherwise>
				<tr>
					<td colspan="5" align="center">▒▒▒▒ 결과값이 없습니다.▒▒▒▒</td>
				</tr>
				</c:otherwise>
				</c:choose>
			</table>
...
<table width="100%" cellpadding="10" cellspacing="0" border="0">
	<tr>
		<td align="right">
			<input type="button" value="처음으로" onclick="location.href='listSecede.asp';" class="button_1">
			<input type="button" value="선택회원 삭제" onclick="LA_secede();" class="button_1" style="width:120;">
		</td>
	</tr>
</table>
