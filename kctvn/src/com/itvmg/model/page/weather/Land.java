...
public class Land implements ActionModel {
	...
	public void execute(HttpServlet servlet, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		String query = "";
		query += "(SELECT W3_X, W3_Y, RD_NAME, ROUND(W3_PTY) W3_PTY, ROUND(W3_SKY) W3_SKY, ROUND(W3_T3H) W3_T3H, RD_SCREEN_X, RD_SCREEN_Y, RD_ORDER, ROUND(WL_T1H) WL_T1H FROM WEATHER LEFT JOIN REGION_COORD ON RD_X = W3_X AND RD_Y = W3_Y LEFT JOIN WEATHER_LIVE ON WL_X = W3_X AND WL_Y = W3_Y WHERE W3_X = '52' AND W3_Y = '38' ORDER BY W3_SEQ LIMIT 1)";
		query += " UNION (SELECT W3_X, W3_Y, RD_NAME, ROUND(W3_PTY) W3_PTY, ROUND(W3_SKY) W3_SKY, ROUND(W3_T3H) W3_T3H, RD_SCREEN_X, RD_SCREEN_Y, RD_ORDER, ROUND(WL_T1H) WL_T1H  FROM WEATHER LEFT JOIN REGION_COORD ON RD_X = W3_X AND RD_Y = W3_Y LEFT JOIN WEATHER_LIVE ON WL_X = W3_X AND WL_Y = W3_Y WHERE W3_X = '59' AND W3_Y = '38' ORDER BY W3_SEQ LIMIT 1)";
		query += " UNION (SELECT W3_X, W3_Y, RD_NAME, ROUND(W3_PTY) W3_PTY, ROUND(W3_SKY) W3_SKY, ROUND(W3_T3H) W3_T3H, RD_SCREEN_X, RD_SCREEN_Y, RD_ORDER, ROUND(WL_T1H) WL_T1H  FROM WEATHER LEFT JOIN REGION_COORD ON RD_X = W3_X AND RD_Y = W3_Y LEFT JOIN WEATHER_LIVE ON WL_X = W3_X AND WL_Y = W3_Y WHERE W3_X = '58' AND W3_Y = '34' ORDER BY W3_SEQ LIMIT 1)";
		query += " UNION (SELECT W3_X, W3_Y, RD_NAME, ROUND(W3_PTY) W3_PTY, ROUND(W3_SKY) W3_SKY, ROUND(W3_T3H) W3_T3H, RD_SCREEN_X, RD_SCREEN_Y, RD_ORDER, ROUND(WL_T1H) WL_T1H  FROM WEATHER LEFT JOIN REGION_COORD ON RD_X = W3_X AND RD_Y = W3_Y LEFT JOIN WEATHER_LIVE ON WL_X = W3_X AND WL_Y = W3_Y WHERE W3_X = '53' AND W3_Y = '32' ORDER BY W3_SEQ LIMIT 1)";
		query += " UNION (SELECT W3_X, W3_Y, RD_NAME, ROUND(W3_PTY) W3_PTY, ROUND(W3_SKY) W3_SKY, ROUND(W3_T3H) W3_T3H, RD_SCREEN_X, RD_SCREEN_Y, RD_ORDER, ROUND(WL_T1H) WL_T1H  FROM WEATHER LEFT JOIN REGION_COORD ON RD_X = W3_X AND RD_Y = W3_Y LEFT JOIN WEATHER_LIVE ON WL_X = W3_X AND WL_Y = W3_Y WHERE W3_X = '48' AND W3_Y = '32' ORDER BY W3_SEQ LIMIT 1)";
		query += " UNION (SELECT W3_X, W3_Y, RD_NAME, ROUND(W3_PTY) W3_PTY, ROUND(W3_SKY) W3_SKY, ROUND(W3_T3H) W3_T3H, RD_SCREEN_X, RD_SCREEN_Y, RD_ORDER, ROUND(WL_T1H) WL_T1H  FROM WEATHER LEFT JOIN REGION_COORD ON RD_X = W3_X AND RD_Y = W3_Y LEFT JOIN WEATHER_LIVE ON WL_X = W3_X AND WL_Y = W3_Y WHERE W3_X = '48' AND W3_Y = '36' ORDER BY W3_SEQ LIMIT 1)";
		query += " UNION (SELECT W3_X, W3_Y, RD_NAME, ROUND(W3_PTY) W3_PTY, ROUND(W3_SKY) W3_SKY, ROUND(W3_T3H) W3_T3H, RD_SCREEN_X, RD_SCREEN_Y, RD_ORDER, ROUND(WL_T1H) WL_T1H  FROM WEATHER LEFT JOIN REGION_COORD ON RD_X = W3_X AND RD_Y = W3_Y LEFT JOIN WEATHER_LIVE ON WL_X = W3_X AND WL_Y = W3_Y WHERE W3_X = '53' AND W3_Y = '35' ORDER BY W3_SEQ LIMIT 1)";
