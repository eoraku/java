...
<script type='text/javascript'>
	...
	*/
	...
	function drawBg() {
		...
		//$D.create("font").setPos(78, 30).setFontSize(18).setColor("#0e3c5d").setText("날씨 | 전국해상  | 상세예보").draw();
	...
	function drawFix() {
		...
		$D.create("font").setPos(50, 267).setSize(72, 25).setAlign("center").setFontSize(16).setColor("#828282").setText("풍향").draw();
		$D.create("font").setPos(50, 299).setSize(72, 37).setAlign("center").setFontSize(16).setColor("#828282").setText("풍속").draw();
		$D.create("font").setPos(50, 319).setSize(72, 37).setAlign("center").setFontSize(16).setColor("#828282").setText("(m/s)").draw();
	...
	function drawDiv() {
		...
		//풍향영역지정
		var wd_to = $D.create("font").setId("wd_to").setFontSize(18).setColor("#323232").setSize(134, 24).setAlign("center").setPos(125, 265).draw();
		var wd_tm_m = $D.create("font").setId("wd_tm_m").setFontSize(18).setColor("#323232").setSize(134, 24).setAlign("center").setPos(259, 265).draw();
		var wd_tm_a = $D.create("font").setId("wd_tm_a").setFontSize(18).setColor("#323232").setSize(134, 24).setAlign("center").setPos(393, 265).draw();
		var wd_a = $D.create("font").setId("wd_a").setFontSize(18).setColor("#323232").setSize(134, 24).setAlign("center").setPos(527, 265).draw();

		//풍속영역지정
		var ws_to = $D.create("font").setId("ws_to").setFontSize(26).setColor("#205879").setSize(134, 25).setAlign("center").setPos(125, 302).draw();
		var ws_tm_m = $D.create("font").setId("ws_tm_m").setFontSize(26).setColor("#205879").setSize(134, 25).setAlign("center").setPos(259, 302).draw();
		var ws_tm_a = $D.create("font").setId("ws_tm_a").setFontSize(26).setColor("#205879").setSize(134, 25).setAlign("center").setPos(393, 302).draw();
		var ws_a = $D.create("font").setId("ws_a").setFontSize(26).setColor("#205879").setSize(134, 25).setAlign("center").setPos(527, 302).draw();

		//파고영역지정
		var pg_to = $D.create("font").setId("pg_to").setFontSize(18).setColor("#323232").setSize(134, 25).setAlign("center").setPos(125, 353).draw();
		var pg_tm_m = $D.create("font").setId("pg_tm_m").setFontSize(18).setColor("#323232").setSize(134, 25).setAlign("center").setPos(259, 353).draw();
		var pg_tm_a = $D.create("font").setId("pg_tm_a").setFontSize(18).setColor("#323232").setSize(134, 25).setAlign("center").setPos(393, 353).draw();
		var pg_a = $D.create("font").setId("pg_a").setFontSize(18).setColor("#323232").setSize(134, 25).setAlign("center").setPos(527, 353).draw();
	}
	...
	function reloadPageData(){
		...
		ajax.setParam("command", "nationalseadetail");
