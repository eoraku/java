...
<dl id="news_leftmenu">
	...
	<dd>
		<ul id="news_leftmenu_menus">
			...
			<li><a <c:if test="${guid!=9 }">class="out" </c:if>href="list.htm?guid=9"><img src="../images/news/leftmenu_9_over.png" width="127" height="19" alt="영어뉴스(English News)"/></a></li>
			<li><a <c:if test="${guid!=10 }">class="out" </c:if>href="list.htm?guid=10"><img src="../images/news/leftmenu_10_over.png" width="127" height="19" alt="중국어뉴스(中文新闻)"/></a></li>
...
<dl id="news_leftvod">
	...
	<dd>
		<ul>
			<li><a <c:if test="${guid==0 }">class="bold" </c:if>href="${ctxRoot }news/vod.htm">전체보기</a></li>
			<li><a <c:if test="${guid==11 }">class="bold" </c:if>href="${ctxRoot }news/vod.htm?guid=11&pageNo=1&schType=name&schText=아침">아침뉴스</a></li>
			<li><a <c:if test="${guid==12 }">class="bold" </c:if>href="${ctxRoot }news/vod.htm?guid=12&pageNo=1&schType=name&schText=낮">낮뉴스</a></li>
			<li><a <c:if test="${guid==13 }">class="bold" </c:if>href="${ctxRoot }news/vod.htm?guid=13&pageNo=1&schType=name&schText=저녁">저녁뉴스</a></li>
			<li><a <c:if test="${guid==14 }">class="bold" </c:if>href="${ctxRoot }news/vod.htm?guid=14&pageNo=1&schType=name&schText=주말">주말뉴스</a></li>
		</ul>
	</dd>
...
<dl id="news_leftext">
	...
	<dd>
		<ul>
			<li><a href="${ctxRoot }news/vod.htm?guid=1">뉴스편성표</a></li>
			<li><a href="${ctxRoot }news/vod.htm?guid=2">뉴스 검색</a></li>
		</ul>
	</dd>
