...
$(document).ready(function(){
	$("form").submit(function(){
		if(!chkInputEmpty("#name","'해지신청자이름'을 입력해주세요.")) return false;
		if(!chkInputEmpty("#htrg","'해지시 전화번호'를 입력해주세요.")) return false;
		if(!chkInputEmpty("#htel_1","'해지시 전화번호'를 입력해주세요.")) return false;
		if(!chkInputEmpty("#htel_2","'해지시 전화번호'를 입력해주세요.")) return false;
