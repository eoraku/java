			...
			if(ss.contains(msg)){
				...
				while(true){
					if(imageurl.contains("chart-row__image")){
						...
						if(imageurl.contains("https://") && imageurl.contains(".jpg")){// 以묒슂 �닔�젙 http-> https
						//if(imageurl.contains("images/pref_images")){
							break;
						}else{  // 以묒슂 �닔�젙 http-> https
				...
				//System.out.println("??------"+imageurl);
				imageurl=imageurl.substring(imageurl.indexOf("https://"));   // 以묒슂 �닔�젙 http-> https
