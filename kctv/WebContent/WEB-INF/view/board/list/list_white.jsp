		...
		<tr>
			<td class="td_category_faq" colspan="5">
				<dl>
					...
					<dd class="td_top_padding"><a href="customer.htm?muid=203&cuid=1"><img src="${ctxRoot }images/board/digital.gif" width="129" height="32" alt="디지털케이블TV"/></a></dd>
					<dd class="td_top_padding"><a href="customer.htm?muid=203&cuid=3"><img src="${ctxRoot }images/board/internet.gif" width="109" height="31" alt="초고속인터넷"/></a></dd>
					<dd class="td_top_padding"><a href="customer.htm?muid=203&cuid=4"><img src="${ctxRoot }images/board/phone.gif" width="109" height="32" alt="인터넷전화"/></a></dd>
					<dd><a href="https://www.kcttel.com/ft/kctweb007/kctweb007110.jsp" target="_blank"><img src="${ctxRoot }images/board/national.gif" width="168" height="51" alt="국제전화 00777"/></a></dd>
				</dl>
			</td>
		</tr>
		</c:if>
