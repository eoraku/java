...
public class LandDetail implements ActionModel {
	...
	public void execute(HttpServlet servlet, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		query += " ROUND(W3_SKY) W3_SKY, ROUND(W3_WSD) W3_WSD, W3_WAV, ROUND(W3_R12) W3_R12, ROUND(W3_S12) W3_S12";
		query += " FROM WEATHER";
		query += " WHERE W3_X = '";
		query += w3_x;
		query += "' AND W3_Y = '";
...
/*
SELECT W3_TIME, ROUND(W3_T3H) W3_T3H, ROUND(W3_PTY) W3_PTY,
ROUND(W3_SKY) W3_SKY, ROUND(W3_WSD) W3_WSD, W3_WAV, ROUND(W3_R12) W3_R12, ROUND(W3_S12) W3_S12
FROM WEATHER
WHERE W3_X = '' AND W3_Y = '' 
