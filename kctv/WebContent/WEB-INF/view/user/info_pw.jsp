...
<div id="common_main">
	...
	<div id="info_content">
		<form name="chk_pw" method="post" target="exec_iframe" action="chk_pw.htm">
		<div id="info_pw_form">
			<div id="form_inner">
				...
				<div id="form_message"><br/>
					외부로부터 <span style="font-weight:bold;color:#339900">${userid }</span>님의 정보를 안전하게 보호하기 위해 비밀번호를 다시 한 번 확인 합니다.<br/>
