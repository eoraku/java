...
<div id="join_top_step"><img src="${ctxRoot }images/user/join_step2.gif" width="930" height="53"/></div>
<div id="common_main">
	<div id="join_step2">
		...
		<dl id="join_step2_text">
			...
			<dd>본인 동의없는 타인에 의한 부정 회원가입을 방지하기 위하여 회원본인확인인증을 시행하고 있습니다.</dd>
			<dd>아래의 휴대폰 본인확인 또는 아이핀 중 하나를 선택하여 KCTV 회원가입을 진행하여 주시기 바랍니다.</dd>
			<dd>입력하신 소중한 개인정보는 회원님의 동의 없이 공개 또는 제3자에게 제공되지 않습니다.</dd>
			<dd>입력하신 정보는 가입 완료 전까지는 저장되지 않습니다.</dd>
		...
		<ul id="join_step2_box">
			...
			<li>
				<dl class="join_ipin">
					<dt><img src="${ctxRoot }images/user/real_icon_ipin.png" width="144" height="44"/></dt>
