...
<body>
<textarea id="contents_old" style="width:0px;height:0px;display:none;">${item.content }</textarea>
<form method="post" name="frmWrite" enctype="multipart/form-data" action="insert1.asp">
<input type="hidden" name="mode" value="${mode }"/>
<input type="hidden" name="num" value="${item.num }"/>
<input type="hidden" name="orgFile" value="${item.svrfile2 }"/>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td>
			<table width="100%" border="0" cellspacing="1" cellpadding="0">
				...
				<tr>
					<td height="30" colspan="2" align="center" bgcolor="599BB4"><strong><font color="#FFFFFF">기사작성</font></strong></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" style="width:50%;" name="name" value="${item.name }" readonly="readonly"></td>
				</tr>
				<tr>
					<td height="5" colspan="2" background="images/dotline.gif"></td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<c:choose>
						<c:when test="${item.maincd=='eng ' }">
						<input type="radio" name="eng_chi" value=""/> 국내뉴스&nbsp;
						<input type="radio" name="eng_chi" value="eng" checked="checked"/> 영어뉴스&nbsp;
						<input type="radio" name="eng_chi" value="chi"/> 중국어뉴스
						</c:when>
						<c:when test="${item.maincd=='chi ' }">
						<input type="radio" name="eng_chi" value=""/> 국내뉴스&nbsp;
						<input type="radio" name="eng_chi" value="eng"/> 영어뉴스&nbsp;
						<input type="radio" name="eng_chi" value="chi" checked="checked"/> 중국어뉴스
						</c:when>
						<c:otherwise>
						<input type="radio" name="eng_chi" value="" checked="checked"/> 국내뉴스&nbsp;
						<input type="radio" name="eng_chi" value="eng"/> 영어뉴스&nbsp;
						<input type="radio" name="eng_chi" value="chi"/> 중국어뉴스
						</c:otherwise>
						</c:choose>
				...
				<tr>
					...
					<td height="80" valign="top">
						<table width="100%" height="100%" border="0" cellpadding="8" cellspacing="0">
							<tr>
								<td valign="top"><textarea rows="4" style="width:100%;" name="p_news_goal">${item.news_goal }</textarea></td>
							</tr>
						</table>
					</td>
				</tr>
	...
	<tr>
		<td align="center">
			...
			<a href="list1.asp"><img src="../../images/admin/btn_list.gif" width="61" height="22" border="0" alt="목록"></a>
		</td>
	</tr>
</table>
</form>
