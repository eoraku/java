...
<script type="text/javascript">
	...
	function init(param) {
		...
		//okKey.draw();
		//exitKey.draw();
		$D.create("font").setFontSize(18).setColor("#0e3c5d").setPos(320, 52).setText("항공사 선택").draw();
	...
	function setListData(){
		...
		for ( var i = 0; i < list.length; i++) {
			...
			$D.create("font").setId("listFont"+i).setFontSize(17).setPos(294, 93 + padding).setText(list[i]).draw();
		}
	}
...
<img src="${imgRoot}/common/st_01.png" style="position:absolute; left:283px; top:46px;"/>
