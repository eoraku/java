...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td style="padding:10px;"><img src="../../images/admin/bul02.gif" width="4" height="5" hspace="8" align="absmiddle"><b>회원리스트</b></td>
	</tr>
</table>
<table width="100%" border="0" cellpadding="3" cellspacing="0">
	<tr>
		<td>
			<form name="user_sch_form"method="get" action="list.asp" style="margin:0;border:0;">
							...
							<tr>
								<td align="right">
									...
									<select name="schType">
										...
										<option value="address"<c:if test="${schType=='address' }"> selected="selected"</c:if>>지역</option>
										<option value="email"<c:if test="${schType=='email' }"> selected="selected"</c:if>>이메일</option>
									</select>
...
<table width="100%" cellpadding="10" cellspacing="0" border="0">
	<tr>
		...
		<td align="right">
			...
			<input type="button" value="선택회원 탈퇴" onclick="LA_secede();" class="button_1" style="width:120;">
		</td>
	</tr>
</table>
